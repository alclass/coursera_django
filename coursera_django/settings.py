...
# system time zone.
TIME_ZONE = None # 'America/Brasilia'
...
SECRET_KEY = '+_d=04r97y2050d0m57234rep#@tw68nj7hlr1m^qmm388)(47'
...
ROOT_URLCONF = 'coursera_django.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'coursera_django.wsgi.application'
